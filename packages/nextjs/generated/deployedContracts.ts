  ...
  5: [
    {
      ...
      contracts: {
        ERC6551Manager: {
          address: "0x82e725a8f9c70edf0ad3B793D5616870f3264da3",
          abi: [
            {
              inputs: [
                {
        ...
        SparkIdentityTokenFactory: {
          address: "0x3741BF7a3f31958D0b3bf46211f9102FD02d3cc0",
          abi: [
            {
              inputs: [
                {
            ...
            },
            {
              ...
              name: "SparkIdentityTokenContractDeployed",
              type: "event",
            },
            {
              inputs: [],
        ...
        SparkRegistryFactory: {
          address: "0xf55536261d78fc0Cd4768605d380466DCCe2E8dE",
          abi: [
            {
              inputs: [
                {
            ...
            },
            {
              ...
              name: "SparkRegistryContractDeployed",
              type: "event",
            },
            {
              inputs: [],
  ...
  80001: [
    {
      ...
      contracts: {
        ERC6551Manager: {
          address: "0xAff1E468C13F39fb7827d61FBA816F03FA6eC472",
          abi: [
            {
              inputs: [
                {
        ...
        SparkIdentityTokenFactory: {
          address: "0x22C46A236A16b6C436F90c90938249d207F747c7",
          abi: [
            {
              inputs: [
                {
        ...
        SparkRegistryFactory: {
          address: "0xFFB8446c654C507cb1E0e55066AA5bF115BD9fDe",
          abi: [
            {
              inputs: [
                {
  ...
  11155111: [
    {
      ...
      contracts: {
        ERC6551Manager: {
          address: "0xCDABd764e0D293150D24Cdc153EB9D11196212a5",
          abi: [
            {
              inputs: [
                {
        ...
        SparkIdentityTokenFactory: {
          address: "0x7C95bc571A611A287a52dC30b208D61DDD3f7f72",
          abi: [
            {
              inputs: [
                {
        ...
        SparkRegistryFactory: {
          address: "0x241DE3ce6D38B11518A8724F05f394735d3D6FbB",
          abi: [
            {
              inputs: [
                {
